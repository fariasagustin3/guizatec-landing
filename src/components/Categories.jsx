    ...
    <div>
      ...
      <div className='w-screen flex items-center flex-wrap px-5 md:pl-24 gap-5 md:gap-10 mb-10'>
        <button
          ...
          className={selected === "todos" ? 'py-5 px-3 text-sm font-semibold text-white hover:text-gray-400 transition-all duration-500 bg-[#731523] rounded-md' : "bg-transparent font-semibold hover:text-[#000] transition-all duration-500 py-5"}>TODOS</button>
        <button
          onClick={() => setSelected("computadoras")}
          className={selected === "computadoras" ? 'py-5 px-3 text-sm font-semibold text-white hover:text-gray-400 transition-all duration-500 bg-[#731523] rounded-md' : "bg-transparent font-semibold hover:text-[#000] transition-all duration-500 py-5"}>COMPUTADORAS</button>
        <button
          onClick={() => setSelected("perifericos")}
          className={selected === "perifericos" ? 'py-5 px-3 text-sm font-semibold text-white hover:text-gray-400 transition-all duration-500 bg-[#731523] rounded-md' : "bg-transparent font-semibold hover:text-[#000] transition-all duration-500 py-5"}>PERIFÉRICOS</button>
        <button
          onClick={() => setSelected("cartelera_digital")}
          className={selected === "cartelera_digital" ? 'py-5 px-3 text-sm font-semibold text-white hover:text-gray-400 transition-all duration-500 bg-[#731523] rounded-md' : "bg-transparent font-semibold hover:text-[#000] transition-all duration-500 py-5"}>CARTELERA DIGITAL</button>
        <button
          onClick={() => setSelected("audio")}
          className={selected === "audio" ? 'py-5 px-3 text-sm font-semibold text-white hover:text-gray-400 transition-all duration-500 bg-[#731523] rounded-md' : "bg-transparent font-semibold hover:text-[#000] transition-all duration-500 py-5"}>AUDIO</button>
      </div>
